...
pub trait DkimRepository: Send + Sync {
    async fn find_key_by_id(&self, id: i32) -> Result<Option<DkimKeyResponse>, CoreError>;
    ...
    async fn delete_key(&self, id: i32) -> Result<(), CoreError>;
    ...
    async fn delete_signing(&self, id: i32) -> Result<(), CoreError>;
}
