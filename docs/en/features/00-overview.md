...
|---|--------|-------------|----------|
| 01 | [Domains](01-domains/) | Virtual domain and alias domain management | P0 |
| 02 | [Mailboxes](02-mailboxes/) | Mailboxes, quotas, maildir | P0 |
| 03 | [Aliases](03-aliases/) | Email aliases, distribution lists | P0 |
| 04 | [Authentication](04-authentication/) | Admin/user login, passwords, TOTP, app passwords | P0 |
| 05 | [Authorization](05-authorization/) | RBAC: superadmin, domain admin, user | P0 |
| 06 | [Vacation](06-vacation/) | Automatic replier / out-of-office | P1 |
| 07 | [Fetchmail](07-fetchmail/) | Remote mail retrieval (POP3/IMAP) | P2 |
| 08 | [DKIM](08-dkim/) | DKIM key and signature management | P1 |
| 09 | [Logging](09-logging/) | Admin action audit log | P0 |
